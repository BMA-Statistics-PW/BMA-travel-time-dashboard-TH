...
(function () {
  ...
  const TRANSLATIONS = {
    th: {
      ...
      methodTitle: 'Floating Car Method — รถสำรวจตามกระแสจราจร',
      ...
      cmpThInner: 'สจส. ชั้นใน<br><small>27 ถนน</small>',
      cmpThMiddle: 'สจส. ชั้นกลาง<br><small>17 ถนน</small>',
      ...
      rScope1: '27 ถนน เร่งด่วนเช้า–เย็น',
      rScope2: '17 ถนน เร่งด่วนเช้า–เย็น',
  ...
  rtToggleHide: '🔼 ซ่อนตาราง',
      ...
      dataLoadError: 'ไม่สามารถโหลดข้อมูลได้ กรุณาเปิดผ่าน HTTP Server เช่น `python3 -m http.server 8080` แล้วลองใหม่',
      aboutHead: '👤 เกี่ยวกับผู้วิเคราะห์ข้อมูล',
      aboutName: '© Prapawadee Wachiraput',
      aboutRole: 'Professional-Level Statistician · นักวิชาการสถิติชำนาญการ',
      aboutOrg: 'กลุ่มงานสถิติและวิจัย · กองนโยบายและแผนงาน<br>สำนักการจราจรและขนส่ง · กรุงเทพมหานคร<br><em>Statistics &amp; Research Group, Policy &amp; Planning Division,<br>Traffic and Transportation Department, Bangkok Metropolitan Administration</em>',
      aboutBio: 'นักวิชาการสถิติ ระดับชำนาญการ ที่มุ่งเน้นการนำข้อมูลและวิทยาศาสตร์ข้อมูล (Data Science) มาประยุกต์ใช้กับงานนโยบายภาครัฐ โดยเฉพาะด้านการจราจรและขนส่ง สนใจการวิเคราะห์เชิงพื้นที่ (Spatial Analytics), การออกแบบโครงการวิจัย, และการเล่าเรื่องด้วยข้อมูล (Data Storytelling) เพื่อสนับสนุนการตัดสินใจเชิงนโยบายของกรุงเทพมหานครให้มีประสิทธิภาพและโปร่งใส',
      aboutSkill1: '📊 การวิเคราะห์ทางสถิติ',
      aboutSkill2: '🐍 Python (pandas / numpy)',
      aboutSkill3: '📈 การสร้างภาพข้อมูล',
      aboutSkill4: '🗺 การวิเคราะห์เชิงพื้นที่',
      aboutSkill5: '📐 การออกแบบการสำรวจและวิจัย',
      aboutSkill6: '📝 รายงานทางการ (ภาษาไทย)',
      aboutSkill7: '🎨 กราฟิกดีไซน์ / อินโฟกราฟิก',
      aboutSkill8: '🌐 HTML / CSS / JS',
    ...
    en: {
      ...
      cmpThInner: 'BMA Inner<br><small>27 roads</small>',
      cmpThMiddle: 'BMA Middle<br><small>17 roads</small>',
      ...
      rScope: 'Scope',
      rScope1: '27 roads · AM/PM rush',
      rScope2: '17 roads · AM/PM rush',
  ...
  rtToggleHide: '🔼 Hide Table',
      ...
      dataLoadError: 'Unable to load dashboard data. Please run via HTTP server (for example: `python3 -m http.server 8080`) and try again.',
      aboutHead: '👤 About the Analyst',
      aboutName: '© Prapawadee Wachiraput',
      aboutRole: 'Professional-Level Statistician',
      aboutOrg: 'Statistics &amp; Research Group · Policy &amp; Planning Division<br>Traffic and Transportation Department · Bangkok Metropolitan Administration',
      aboutBio: 'A professional statistician focused on applying data and data science to public policy, especially transport and traffic management. Interests include spatial analytics, research design, and data storytelling to support effective and transparent policy decisions for Bangkok.',
      aboutSkill1: '📊 Statistical Analysis',
      aboutSkill2: '🐍 Python (pandas / numpy)',
      aboutSkill3: '📈 Data Visualization',
      aboutSkill4: '🗺 Spatial Analytics',
      aboutSkill5: '📐 Survey &amp; Research Design',
      aboutSkill6: '📝 Official Reports (Thai)',
      aboutSkill7: '🎨 Graphic Design / Infographics',
      aboutSkill8: '🌐 HTML / CSS / JS',
